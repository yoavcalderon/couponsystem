...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.loginService.login(this.emailVar, this.passwordVar, this.typeVar).subscribe(function (response) {
            if (response.token) {
                sessionStorage.token = response.token;
                sessionStorage.typeVar = _this.typeVar;
                _this.routeToUser(sessionStorage.typeVar);
            }
        });
    };
    ...
    LoginComponent.prototype.routeToUser = function (typeVar) {
        switch (typeVar) {
            case "ADMINISTRATOR":
...
var AddCompanyComponent = /** @class */ (function () {
    ...
    AddCompanyComponent.prototype.createCompany = function () {
        this.service.addCompany(this.company).subscribe(function (comp) {
            if (comp) {
...
var AddCustomerComponent = /** @class */ (function () {
    function AddCustomerComponent(service, router) {
        this.service = service;
        this.router = router;
...
var DeleteCompanyComponent = /** @class */ (function () {
    function DeleteCompanyComponent(service, router) {
        this.service = service;
        this.router = router;
        this.company = new src_app_models_Company__WEBPACK_IMPORTED_MODULE_3__["Company"]();
    }
    ...
    DeleteCompanyComponent.prototype.deleteCompany = function (id) {
        var _this = this;
...
var DeleteCustomerComponent = /** @class */ (function () {
    function DeleteCustomerComponent(service, router) {
        this.service = service;
        this.router = router;
        this.customer = new src_app_models_Customer__WEBPACK_IMPORTED_MODULE_4__["Customer"]();
    }
    ...
    DeleteCustomerComponent.prototype.deleteCustomer = function (customer) {
        var _this = this;
        var result = confirm("are you sure you want to delete" + this.customer.firstName + "?");
        if (result) {
            this.service.deleteCustomer(this.customer).subscribe(function () {
                _this.ngOnInit();
            });
        }
    };
...
var GetAllCompaniesComponent = /** @class */ (function () {
    function GetAllCompaniesComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetAllCompaniesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getAllCompanies().subscribe(function (comp) {
...
var GetAllCustomersComponent = /** @class */ (function () {
    function GetAllCustomersComponent(service, router) {
        this.service = service;
        this.router = router;
    }
    GetAllCustomersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getAllCustomers().subscribe(function (cust) {
            _this.customers = cust;
        });
    };
    GetAllCustomersComponent.prototype.deleteCustomer = function (customer) {
        var _this = this;
    ...
    GetAllCustomersComponent.prototype.editorEnabler = function (customer) {
...
var GetOneCompanyComponent = /** @class */ (function () {
    function GetOneCompanyComponent(service, router) {
        this.service = service;
        this.router = router;
    ...
    GetOneCompanyComponent.prototype.getOneCompany = function (id) {
        this.service.getOneCompany(id).subscribe(function (comp) {
            if (comp) {
                alert(comp);
            }
            else {
...
var GetOneCustomerComponent = /** @class */ (function () {
    function GetOneCustomerComponent(service, router) {
        this.service = service;
        this.router = router;
    ...
    GetOneCustomerComponent.prototype.getOneCustomer = function (id) {
        this.service.getOneCustomer(this.customer.id).subscribe(function (cust) {
            if (cust) {
                alert(cust);
            }
            else {
...
var UpdateCompanyComponent = /** @class */ (function () {
    function UpdateCompanyComponent(service, router) {
        this.service = service;
        this.router = router;
        this.company = new src_app_models_Company__WEBPACK_IMPORTED_MODULE_2__["Company"]();
    }
    ...
    UpdateCompanyComponent.prototype.updateCompany = function (company) {
        this.service.updateCompany(company).subscribe(function (comp) {
            alert("the company has been updated");
        });
    };
    UpdateCompanyComponent.prototype.loadComp = function (id) {
        var _this = this;
        this.service.getOneCompany(id).subscribe(function (comp) { _this.company = comp; });
    };
...
var UpdateCustomerComponent = /** @class */ (function () {
    function UpdateCustomerComponent(service, router) {
        this.service = service;
        this.router = router;
        this.customer = new src_app_models_Customer__WEBPACK_IMPORTED_MODULE_2__["Customer"]();
    }
    ...
    UpdateCustomerComponent.prototype.updateCustomer = function (customer) {
        var _this = this;
        this.service.updateCustomer(customer).subscribe(function (cust) {
            if (cust) {
                _this.router.navigate(["/getAllCustomers"]);
            }
        });
    };
...
var categoryFilterPipe = /** @class */ (function () {
    ...
    categoryFilterPipe.prototype.transform = function (coupons, searchTerm) {
        if (!coupons || !searchTerm) {
            return coupons;
        }
        return coupons.filter(function (coup) { return coup.category.toLowerCase().indexOf(searchTerm.toLowerCase()) == 0; });
    };
...
var AddCouponComponent = /** @class */ (function () {
    function AddCouponComponent(service, router) {
        this.service = service;
        this.router = router;
    ...
    AddCouponComponent.prototype.createCoupon = function () {
        ...
        this.service.addCoupon(this.coupon).subscribe(function (coup) {
            if (coup) {
                coup.company = _this.company;
...
var DeleteCouponComponent = /** @class */ (function () {
    function DeleteCouponComponent(service, router) {
        this.service = service;
        this.router = router;
        this.coupon = new src_app_models_Coupon__WEBPACK_IMPORTED_MODULE_2__["Coupon"]();
    }
    ...
    DeleteCouponComponent.prototype.deleteCompany = function (id) {
        var _this = this;
        var result = confirm("are you sure you want to delete" + this.coupon.title + "?");
        if (result) {
            this.service.deleteCoupon(id).subscribe(function () {
                _this.ngOnInit();
            });
        }
    };
...
var GetCompanyCouponsCategoryComponent = /** @class */ (function () {
    function GetCompanyCouponsCategoryComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetCompanyCouponsCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        // this.service.getCompanyCoupons(this.category).subscribe((coup)=>{
        this.service.getCompanyCoupons().subscribe(function (coup) {
            _this.coupons = coup;
        });
    };
    GetCompanyCouponsCategoryComponent.prototype.deleteCoupon = function (id) {
        var _this = this;
    ...
    GetCompanyCouponsCategoryComponent.ctorParameters = function () { return [
    ...
    return GetCompanyCouponsCategoryComponent;
}());
...
var GetCompanyCouponsPriceComponent = /** @class */ (function () {
    function GetCompanyCouponsPriceComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetCompanyCouponsPriceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getCouponsByPrice(this.price).subscribe(function (coup) {
            _this.coupons = coup;
        });
    };
    GetCompanyCouponsPriceComponent.prototype.deleteCoupon = function (id) {
        var _this = this;
        var result = confirm("Are you sure you would like to delete this Coupon?");
        if (result) {
            this.service.deleteCoupon(id).subscribe(function () {
    ...
    GetCompanyCouponsPriceComponent.ctorParameters = function () { return [
        { type: src_app_services_company_service__WEBPACK_IMPORTED_MODULE_2__["CompanyService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
    ...
    return GetCompanyCouponsPriceComponent;
}());
...
var GetCompanyCouponsComponent = /** @class */ (function () {
    function GetCompanyCouponsComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    ...
    GetCompanyCouponsComponent.prototype.deleteCoupon = function (id) {
        this.service.deleteCoupon(id).subscribe(function () {
        });
        this.ngOnInit();
        {
    ...
    GetCompanyCouponsComponent.prototype.updateCoupon = function (coupon) {
        this.service.updateCoupon(this.coupon).subscribe(function (coup) {
        });
        this.ngOnInit();
    };
    GetCompanyCouponsComponent.prototype.editorEnabler = function (coupon) {
        this.coupon = coupon;
        if (this.updater == false) {
            this.updater = true;
        }
    ...
    GetCompanyCouponsComponent.prototype.categoryFilter = function (category) {
        this.service.getCouponsByCategory(category).subscribe(function (cat) {
        });
        this.ngOnInit();
    };
    GetCompanyCouponsComponent.prototype.priceFilter = function (price) {
        this.service.getCouponsByPrice(price).subscribe(function (price) {
        });
        this.ngOnInit();
    };
    GetCompanyCouponsComponent.ctorParameters = function () { return [
        { type: src_app_services_company_service__WEBPACK_IMPORTED_MODULE_2__["CompanyService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var UpdateCouponComponent = /** @class */ (function () {
    function UpdateCouponComponent(service, router) {
        this.service = service;
        this.router = router;
        this.coupon = new src_app_models_Coupon__WEBPACK_IMPORTED_MODULE_2__["Coupon"]();
    }
    ...
    UpdateCouponComponent.prototype.updateCompany = function (company) {
        this.service.updateCoupon(this.coupon).subscribe(function (coup) {
        });
    };
...
var GetAllCouponsComponent = /** @class */ (function () {
    function GetAllCouponsComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetAllCouponsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getAllCoupons().subscribe(function (coup) {
            _this.coupons = coup;
        });
    };
    GetAllCouponsComponent.ctorParameters = function () { return [
...
var GetCustomerCouponsCategoryComponent = /** @class */ (function () {
    function GetCustomerCouponsCategoryComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetCustomerCouponsCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getCustomerCouponsByCategory(this.category).subscribe(function (coup) {
            _this.coupons = coup;
        });
    };
    GetCustomerCouponsCategoryComponent.ctorParameters = function () { return [
        { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
    ...
    return GetCustomerCouponsCategoryComponent;
}());
...
var GetCustomerCouponsPriceComponent = /** @class */ (function () {
    function GetCustomerCouponsPriceComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetCustomerCouponsPriceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getCustomerCouponsByPrice(this.price).subscribe(function (coup) {
            _this.coupons = coup;
        });
    };
    GetCustomerCouponsPriceComponent.ctorParameters = function () { return [
        { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
    ...
    return GetCustomerCouponsPriceComponent;
}());
...
var GetCustomerCouponsComponent = /** @class */ (function () {
    function GetCustomerCouponsComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    GetCustomerCouponsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getCustomerCoupons().subscribe(function (coup) {
            _this.coupons = coup;
        });
    };
    GetCustomerCouponsComponent.ctorParameters = function () { return [
        { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var GetCustomerDetailsComponent = /** @class */ (function () {
    function GetCustomerDetailsComponent(service, router) {
        this.service = service;
        this.router = router;
        this.customer = new src_app_models_Customer__WEBPACK_IMPORTED_MODULE_2__["Customer"]();
    }
    GetCustomerDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getCustomerDetails().subscribe(function (cust) {
            _this.customer = cust;
            // (cust.id);
            // (cust.email);
            // (cust.firstName);
...
var PurchaseCouponComponent = /** @class */ (function () {
    function PurchaseCouponComponent(service, route) {
        this.service = service;
        this.route = route;
    }
    ...
    PurchaseCouponComponent.prototype.purchaseCoupon = function (coupon) {
        this.service.purchaseCoupon(coupon).subscribe(function () {
        });
        this.ngOnInit();
        {
            alert("purchased");
    ...
    PurchaseCouponComponent.prototype.categoryFilter = function (category) {
        this.service.getCustomerCouponsByCategory(category).subscribe(function (cat) {
        });
        this.ngOnInit();
    };
    PurchaseCouponComponent.prototype.priceFilter = function (price) {
        this.service.getCustomerCouponsByPrice(price).subscribe(function (price) {
        });
        this.ngOnInit();
    };
    PurchaseCouponComponent.ctorParameters = function () { return [
        { type: src_app_services_customer_service__WEBPACK_IMPORTED_MODULE_2__["CustomerService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var priceFilterPipe = /** @class */ (function () {
    ...
    priceFilterPipe.prototype.transform = function (coupons, searchPrice) {
        if (!coupons || !searchPrice) {
            return coupons;
        }
        return coupons.filter(function (coup) { return coup.price > searchPrice; });
    };
...
var CompanyService = /** @class */ (function () {
    ...
    CompanyService.prototype.getCouponsByCategory = function (category) {
    ...
    CompanyService.prototype.getCompanyDetails = function (company) {
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.getCustomerCouponsByCategory = function (category) {
        return this.client.get("http://localhost:8080/customer/getCustomerCouponsCat/" + sessionStorage.token + "/" + category + "/");
    };
    CustomerService.prototype.getCustomerCouponsByPrice = function (price) {
